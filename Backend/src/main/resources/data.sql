...
VALUES
    (1, 'PLASTICO', 1000.0, 'KILOGRAMO', 'NEGRO', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (2, 'PLASTICO', 1000.0, 'KILOGRAMO', 'COLOR', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (3, 'TAPA', 10.0, 'UNIDADES', 'ROSCA', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (4, 'TAPA', 10.0, 'UNIDADES', 'CALCE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (5, 'TORNILLOS', 100.0, 'UNIDADES', 'NONE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (6, 'TORNILLO_GRANDE', 10.0, 'UNIDADES', 'NONE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (7, 'TEE', 40.0, 'UNIDADES', 'NONE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (8, 'STICKER', 100.0, 'UNIDADES', 'TANQUE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (9, 'STICKER', 100.0, 'UNIDADES', 'CAMARA_SEPTICA', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
INSERT INTO TIPO_TANQUE (
    ...
    VOLUMEN_100_KM, VOLUMENT_200_KM,
    TAPA_TIPO, TORNILLO, TORNILLO_GRANDE, TEE, TIPO_STICKER,
    INVENTARIO_PRIMERA, INVENTARIO_SEGUNDA,
    CREATED_DATE, LAST_UPDATED_AT
) VALUES
-- Tanques de agua
( 'Tanque',  'UNICAPA', 300.00,  5.00, 0.00, 23000.00,  2500.00,  5000.00, 'CALCE', 2, 0, false, 'TANQUE', 10, 2, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
( 'Tanque',  'BICAPA',  500.00,  8.50, 1.50, 26000.00,  2700.00,  5400.00, 'ROSCA', 4, 0, false, 'TANQUE', 15, 2, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
( 'Tanque',  'TRICAPA', 750.00, 12.00, 2.20, 29000.00,  2800.00,  5600.00, 'ROSCA', 4, 0, false, 'TANQUE', 12, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
( 'Tanque', 'TRICAPA', 1000.00, 14.00, 3.50, 31000.00, 3000.00,  6000.00, 'ROSCA', 6, 0, false, 'TANQUE', 10, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
( 'Tanque', 'BICAPA',  1100.00, 12.00, 3.00, 32000.00, 3100.00,  6200.00, 'CALCE', 6, 0, false, 'TANQUE', 8,  0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

-- Cámaras sépticas
( 'Cámara Séptica',  'UNICAPA', 800.00, 10.00, 0.00, 28000.00, 2600.00, 5200.00, 'CALCE', 0, 4, true,  'CAMARA_SEPTICA', 6, 3, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
( 'Cámara Séptica', 'UNICAPA', 1200.00, 13.00, 0.00, 33000.00, 3200.00, 6400.00, 'CALCE', 0, 6, true,  'CAMARA_SEPTICA', 4, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
VALUES
    ...
    (2, '2025-06-05 11:00:00', 2600.00, 'PREPARANDO',       CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (3, '2025-06-07 09:30:00', 3100.00, 'PREPARANDO',    CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ...
    (7, '2025-06-15 16:00:00', 2700.00, 'PREPARANDO',       CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (8, '2025-06-18 13:30:00', 1350.00, 'PREPARANDO',    CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
INSERT INTO PEDIDO (CLIENTE_ID, FECHA_ENTREGA, PRECIO_TOTAL, STATE, CREATED_DATE, LAST_UPDATED_AT)
VALUES
    (3, '2025-07-03 11:00:00', 1800.00, 'PREPARANDO',       CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (4, '2025-07-06 09:00:00', 2200.00, 'PREPARANDO',    CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
