...
import {ReportSoldToClientsComponent} from "./features/reports/report-sold-to-clients/report-sold-to-clients.component";
...
export const routes: Routes = [
  ...
  {
    path: 'tanktypes/:id',
    component: TankTypeExamineComponent,
  ...
  {
    path: 'consumables/primary',
    component: PrimaryConsumablesComponent,
    canActivate: [authGuard],
    data: {roles: ['ADMIN']}
  },
  {
    path: 'consumables/secondary',
    component: SecundaryConsumablesComponent,
    canActivate: [authGuard],
    data: {roles: ['ADMIN', 'TRANSPORTISTA']}
  },
  {
    path: 'production',
    component: TankRegistryComponent,
    canActivate: [authGuard],
    data: {roles: ['ADMIN', 'EMPLEADO']}
  },
  {
  ...
  {path: 'report/clients', component: ReportSoldToClientsComponent},
